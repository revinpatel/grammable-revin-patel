...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "shouldn't let users who did not create the gram destroy a gram" do
    ...
    it "should return a 404 error if we cannot find a gram with the id that is specified" do
      user = FactoryBot.create(:user)
      sign_in user
